...
INITTAB_DIR_DST = $(BOARD_DIR_DST)/rootfs_overlay/etc
...
all: $(DEFCONFIG_FILE_DST) $(BOARD_DIR_DST) $(INITTAB_DIR_DST) $(FIRMWARE_AG_DST) $(FIRMWARE_BRCM_DSTS)
...
$(INITTAB_DIR_DST): $(BOARD_DIR_DST)
	mkdir -p $(INITTAB_DIR_DST)
	cp $(BOARD_DIR_SRC)/inittab $(INITTAB_DIR_DST) 
